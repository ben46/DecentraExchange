          ...
          <Grid container direction="column" alignItems="center" spacing={2}>
            <Grid item xs={12} className={classes.fullWidth}>
              <CoinField
                ...
                symbol={coin1.symbol !== undefined ? coin1.symbol : "选币"}
              />
            </Grid>
            ...
            <Grid item xs={12} className={classes.fullWidth}>
              <CoinField
                ...
                symbol={coin2.symbol !== undefined ? coin2.symbol : "选币"}
              />
            </Grid>
            ...
            {/* Balance Display */}
            <Typography variant="h6">您的余额</Typography>
            ...
            {/* Reserves Display */}
            <Typography variant="h6">流动池中的储备量</Typography>
            <Grid container direction="row" justifyContent="space-between">
              <Grid item xs={6}>
                <Typography variant="body1" className={classes.balance}>
