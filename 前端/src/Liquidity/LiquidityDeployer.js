  ...
  return (
    <div>
      ...
      >
        ...
        >
          {/* Balance Display */}
          <Typography variant="h6">你的余额：</Typography>
          ...
          {/* Reserves Display */}
          <Typography variant="h6">当前流动性池储备：</Typography>
          <Grid container direction="row" justifyContent="space-between">
            <Grid item xs={6}>
              <Typography variant="body1" className={classes.balance}>
          ...
          <Typography variant="h6">你的流动性代币：</Typography>
        ...
        <Paper className={classes.paperContainer}>
          ...
          >
            {/* Tokens in */}
            <Typography variant="h6">存入的流动性配对数量：</Typography>
            <Grid container direction="row" justifyContent="space-between">
              <Grid item xs={6}>
                <Typography variant="body1" className={classes.balance}>
            ...
            {/* Liquidity Tokens Display */}
            <Typography variant="h6">估算能换出LP代币：</Typography>
            <Grid container direction="row" justifyContent="center">
              <Grid item xs={6}>
                <Typography variant="body1" className={classes.balance}>
