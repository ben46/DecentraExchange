...
interface MockBoringBatchableInterface extends ethers.utils.Interface {
  functions: {
...
export class MockBoringBatchable extends BaseContract {
  ...
  interface: MockBoringBatchableInterface;
